        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
          ...
          >
            <div className="relative">
              ...
              <img src="/images/geobuk-teacher-mascot.png" alt="거북쌤" className="relative w-48 md:w-64 lg:w-80 drop-shadow-2xl transform hover:scale-105 transition-transform duration-500" />
            </div>
          </motion.div>
