...
import { AdmissionSubtypeCategoryEntity } from './entities/core/admission-subtype-category.entity';
...
export class TypeOrmConfigService implements TypeOrmOptionsFactory {
  ...
  createTypeOrmOptions(): TypeOrmModuleOptions {
    ...
    return {
      ...
      entities: [
        MemberEntity,
        MsAuthMemberEntity, // My 생기부 앱 전용 사용자
        ...
        AdmissionSubtypeCategoryEntity, // 전형 상세 타입 카테고리 (지역인재, 사회적 배려)
