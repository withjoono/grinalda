...
import 'package:turtle_planner/src/screens/auth/login_options/login_options_screen.dart';
...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedSplashScreen(
      ...
      nextScreen: userStorage.read('isFirstTime') != true
          ? const LoginOptionsScreen()
          : const LoginOptionsScreen(), //OnBoardingScreen(),
