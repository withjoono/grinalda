/// Firebase 인증 관련 오류를 처리하기 위한 커스텀 예외 클래스.
class CFirebaseAuthException implements Exception {
  ...
  String get message {
    switch (code) {
      ...
      case 'user-disabled':
        return '이 사용자 계정이 비활성화되었습니다. 지원팀에 문의하세요.';
      case 'user-not-found':
        return '잘못된 로그인 정보입니다. 사용자를 찾을 수 없습니다.';
      case 'wrong-password':
      ...
      case 'email-already-exists':
        return '이미 존재하는 이메일 주소입니다. 다른 이메일을 사용해 주세요.';
      ...
      case 'user-token-revoked':
        return '사용자 토큰이 취소되었습니다. 다시 로그인해 주세요.';
      ...
      case 'invalid-cordova-configuration':
        return '제공된 Cordova 구성이 유효하지 않습니다.';
      case 'app-deleted':
      ...
      default:
        return '예기치 않은 인증 오류가 발생했습니다. 다시 시도해 주세요.';
    }
  }
}
