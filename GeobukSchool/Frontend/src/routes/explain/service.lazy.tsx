...
export const Route = createLazyFileRoute("/explain/service")({
...
function ServicePolicy() {
  return (
    <div className="mx-auto w-full max-w-screen-lg space-y-6 py-6">
      <h2 className="pb-4 text-2xl font-semibold">서비스 이용약관</h2>

      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제1조(목적)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
            이 약관은 (주)청사에이아이 (이하 '회사' 라고 합니다)가 제공하는 제반
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <p>
            10. '할인쿠폰'은 이용자가 회사의 서비스를 이용하면서 그 대가를
            지급하는데 사용하기 위하여 회사가 발행 및 관리하는 지급수단을
            말합니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제3조(약관 외 준칙)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <p>
            이 약관은 (주)청사에이아이(이)가 제공하는 모든 인터넷서비스에
            게시하여 공시합니다. 회사는 '전자상거래등에서의 소비자보호에 관한
            법률(이하 '전자상거래법'이라 함)', '약관의 규제에 관한 법률(이하'
            약관규제법'이라 함)', '정보통신망 이용촉진 및 정보보호 등에 관한
            법률(이하 '정보통신망법'이라 함)' 등 본 서비스와 관련된 법령에
            위배되지 않는 범위에서 이 약관을 변경할 수 있으며, 회사는 약관이
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제5조(이용자에 대한 통지)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제6조(이용계약의 체결)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <p>
            ...
            가입의 신청없이 서비스를 이용하고자 하는 경우에는 회사 서비스 이용을
            위해 결제하는 때
          </p>
          <p>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제7조(회원가입에 대한 승낙)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
          ...
          <p>
            2. 전항에도 불구하고, 다음 각호의 사유에 해당하는 경우 회사는
            회원가입을 보류하거나 거절하는 등 제한할 수 있습니다.
          </p>
          <p className="pl-4">
            - 가입신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는
            경우(단, 회사의 재가입 승낙을 얻은 경우에는 예외로 함)
          </p>
          <p className="pl-4">- 실명이 아니거나 타인의 명의를 도용한 경우</p>
          <p className="pl-4">
            - 회사가 정하는 필수정보를 누락하거나 허위로 기재한 경우
          </p>
          <p className="pl-4">
            - 만 14세 미만의 아동, 만 19세 미만의 미성년자, 피한정후견인,
            피성년후견인이 법정대리인의 동의를 얻지 않은 경우
          </p>
          <p className="pl-4">
            - 이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 이 약관 등
            회사가 규정한 운영원칙을 위반한 경우
          </p>
          <p className="pl-4">
            - 신용정보의 이용과 보호에 관한 법률에 따라 PC통신, 인터넷서비스의
            신용불량자로 등록되어 있는 경우
          </p>
          <p className="pl-4">
            - 정보통신윤리위원회에 PC통신, 인터넷서비스의 불량이용자로 등록되어
            있는 경우
          </p>
          <p className="pl-4">
            - 이미 사용 중인 회원정보 또는 공서양속을 저해하는 아이디를
            사용하고자 하는 경우
          </p>
          <p>
            3. 제1항에 따른 신청에 있어 회사는 서비스 제공에 필요한 경우
          ...
          <p>
            5. 에 따라 서비스 이용을 승낙하지 아니하거나 유보한 경우, 회사는
            원칙적으로 이를 서비스 이용 신청자에게 알리도록 합니다. 단, 회사의
            귀책사유 없이 이용자에게 알릴 수 없는 경우에는 예외로 합니다.
          </p>
          <p>
            6. 이용계약의 성립 시기는 제6조 제1호의 경우에는 회사가 가입완료를
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제8조(회원정보의 변경)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제10조(회사의 의무)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
          ...
          <p className="pl-4">
            - 시스템의 긴급점검, 증설, 교체, 시설의 보수 또는 공사를 하기 위하여
            필요한 경우
          </p>
          <p className="pl-4">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제11조(개인정보보호)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
          ...
          <p>
            2. 회사는 최종 사용일로부터 연속하여 1년 동안 서비스 사용 이력이
            없는 경우 '개인정보보호법' 및 같은 법 시행령의 규정에 따라
            이용자정보를 다른 이용자의 개인정보와 분리하여 별도로 저장 및 관리할
            수 있습니다. 이때 분리 저장된 이용자의 개인정보는 이용자가
            회원탈퇴신청 또는 개인정보삭제 요청을 할때까지 보관됩니다.
          </p>
          <p>
            3. 회사가 이용자의 개인정보의 보호 및 사용에 대해서 관련 법규 및
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제12조(이용자의 의무)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제13조(서비스의 제공)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
          ...
          <p className="pl-4">
            - 학생의 성적 및 생활기록부 등을 기반으로 적합한 대학을 찾아주는
            서비스
          </p>
          <p className="pl-4">
            - 개별 대학의 전형을 분석하여 사용자에게 유리한 전형을 추천하는
            서비스
          </p>
          <p className="pl-4">
            - 사용자의 모의고사 점수를 분석하고 통계를 산출하는 서비스
          </p>
          <p className="pl-4">- 사용자의 학습 계획을 관리하는 서비스</p>
          <p className="pl-4">
            - 각 대학교 정시, 수시 등의 지원 및 전략을 제공하는 서비스
          </p>
          <p className="pl-4">
            - 사용자의 생활기록부를 분석 및 평가하는 서비스
          </p>
        </div>
      </div>

      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제14조(서비스의 제한 등)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <p>
            ...
            통지한 방법 중 하나에 의하고, 이용자가 회사에 대하여 통지한 연락처가
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제16조(손해배상)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
          ...
          <p>
            2. 회사가 제공하는 서비스의 이용과 관련하여 회사의 운영정책 및 개인
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제17조(면책사항)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          ...
          <p>
            4. 회사는 '정보통신망법' 시행령에 따라 2년마다 영리 목적의 광고정
          ...
          <p>
            6. '할인쿠폰'은 회사가 구매활동 또는 이벤트 참여 등에 따른 보상으로
            발행 합니다. 이 때 발행된 쿠폰은 사용하거나 만료되면 소멸되며
            현금으로 환급되지 않습니다.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제19조(유료서비스의 결제 등)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
            1. 회사가 제공하는 유료서비스를 이용하는 경우 이용자는 이용대금을
            납부하는 것을 원칙으로 합니다. 이 때 회사가 제공하는 유료서비스에
            대한 이용요금의 결제방법은 아래 각 호와 같습니다.
          </p>
          <p className="pl-4">
          ...
          <p>
            2. 회사는 이용자가 결제수단에 대해 정당한 사용권한을 가지고 있는지의
            여부를 확인할 수 있으며, 이에 대한 확인이 완료될 때까지 거래 진행을
            중지하거나, 확인이 불가한 해당 거래를 취소할 수 있습니다.
          </p>
          <p>
            3. 회사의 정책 및 제1항의 결제업체(이동통신사, 카드사 등) 및
            결제대행업체의 기준에 따라 이용자 당 월 누적 결제액 및 충전한도가
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제20조(환불)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
          ...
          <p className="pl-4">
            - 지속적으로 이용가능한 서비스는 이용일수에 해당하는 금액을 차감한
            나머지 금액을 환불합니다.
          </p>
          <p>
          ...
          <p className="pl-4">- 구매한 서비스가 제공되지 않은 경우</p>
          <p className="pl-4">
            - 구매한 서비스가 표시 또는 광고 등과 상이하거나 현저한 차이가 있는
            경우
          </p>
          <p className="pl-4">
          ...
          <p>
            ...
            원칙으로 합니다. 다만, 동일한 결제수단으로 환불이 불가능한 경우
            회사가 개별서비스에서 정하는 별도의 방법으로 환불합니다.
          </p>
          <p>
          ...
          <p>5. 환불에 필요한 비용은 귀책사유가 있는 쪽이 부담합니다.</p>
        </div>
      </div>

      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제21조(권리의 귀속)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold">제22조(관할법원 및 준거법)</h3>
        <div className="space-y-2 text-sm text-gray-600">
          <p>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm text-gray-600">
          <p>제1조 본 약관은 2023.06.13부터 시행됩니다.</p>
        </div>
      </div>
    </div>
  );
