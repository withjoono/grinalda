        ...
        <div className="space-y-2">
          <div className="flex">
            <div className="flex flex-col items-center gap-1">
              <img className="h-auto w-10 sm:w-12" src={footerIcon} />
              <span className="text-sm sm:text-base">{"(주)청사에이아이"}</span>
            </div>
          </div>
          <div className="flex w-full flex-col gap-1 text-xs text-foreground/70 sm:text-sm">
            <div className="flex w-full flex-col gap-1 sm:flex-row sm:flex-wrap sm:gap-x-4">
              <span>사업체명 (주)청사에이아이</span>
              <span>대표 성시웅</span>
              <span>사업자등록번호 512-88-03060</span>
              <span>연락처 010-3438-1194</span>
            </div>
            <div className="flex w-full flex-col gap-1 sm:flex-row sm:flex-wrap sm:gap-x-4">
              <span>대전시 서구 청사로 228 1110호</span>
