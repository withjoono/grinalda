...
const SearchUniv = ({ type, selectedUniv, onMajorClick, onMajorsClick }) => {
    ...
    const _getRegions = () => {
        axios
            ...
            .then((res) => {
                console.log('regions: ', res.data.data.map(item => item.code))
                    ...
                    <S.OverflowContainer>
                        <div style={{ width: lineData.labels.length * 300, paddingTop: 36 }}>
                            <Line
                                redraw={true}
                                data={lineData}
                                width={lineData.labels.length * 300}
                                height={350}
                                options={{
                                    legend: {
                                        display: false,
...
const SuitabilityResult = ({ majorResult, selectedUniv, onMajorClick, onMajorsClick }) => {
    const [hardUniv, setHardUniv] = useState([]);
    const [normalUniv, setNormalUniv] = useState([]);
    const [easyUniv, setEasyUniv] = useState([]);
        ...
        <>
            ...
            <S.SuitabilityContainer>
                <S.SelectAllContainer>
                    <S.CheckBoxInput id={`selectAll-0`} type='checkbox' onClick={(e) => onMajorsClick(e, majorResult.filter((major) => major.risk_yn === 'H'))}/>
            ...
            <S.SuitabilityContainer>
                <S.SelectAllContainer>
                    <S.CheckBoxInput id={`selectAll-1`} type='checkbox' onClick={(e) => onMajorsClick(e, majorResult.filter((major) => major.risk_yn === '0'))}/>
            ...
            <S.SuitabilityContainer>
                <S.SelectAllContainer>
                    <S.CheckBoxInput id={`selectAll-2`} type='checkbox' onClick={(e) => onMajorsClick(e, majorResult.filter((major) => major.risk_yn === 'L'))}/>
