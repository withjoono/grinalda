        ...
        <div id={cx('contents')}>
            <div id={cx('discuss')}>
                <div id={cx('discuss_contents')}>
                    <Advice>
                        * 과학을 출제하는 대학마다 범위가 상이합니다. <br></br>* 본인이 가능한 과학 과목을 선택해주세요. <br></br>(주의) 연대와 건국대는 학과마다 과학 선택 과목이 다릅니다. <br></br>이 단계에서는 대학을 선택하시고, 학과를 선택하는 단계에서 학과별 과학 지정 여부를 다시 확인해주세요
                    </Advice>
