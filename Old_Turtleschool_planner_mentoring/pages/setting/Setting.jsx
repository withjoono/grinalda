...
const Setting = () => {
	...
	const logoutbutton = (func) => {return (<div className={styles.Setting_content_name} onClick={func}>로그아웃</div>)}
            ...
            <div className={styles.Setting_page}>
                <div className={styles.Setting_content}>
                    <div className={styles.Setting_section}>
                        ...
                        <div className={styles.Setting_section_content}>
                            ...
                            <Link href="/regular/infoform"><div className={styles.Setting_content_name}>정시 성적 수정</div></Link>
                            <Link href="/mockup/inputchoice"><div className={styles.Setting_content_name}>모의 성적 수정</div></Link>
                            <Link href="/gpa/infoform"><div className={styles.Setting_content_name}>내신 성적 수정</div></Link>
							<Link href="/linkage"><div className={styles.Setting_content_name}>타 계정 연계</div></Link>
               ...
               \
                    ...
                    <div className={styles.Setting_section}>
                        ...
                        <div className={styles.Setting_section_content}>
                            <div className={[styles.Setting_content_version,styles.Setting_content_name].join(' ')}>
                                <div>앱 버전</div>
                                <div>1.0 v</div>
                            </div>
