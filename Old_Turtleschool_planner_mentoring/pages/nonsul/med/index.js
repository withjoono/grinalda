...
const MedNonsul = () => {
    ...
    const onNext = () => {
        if (
            [...formattedSelectedUnivCode, ...formattedFirstSciUnivCode, ...formattedSecondSciUnivCode].length < 1 ||
                    ...
                    <div id={styles.discuss}>
                        <UserAgent computer>
                            <div id={styles.side_menu}>
                                ...
                                <ul className={styles.sub_menu}>
                                    ...
                                    <li>
                                        <a className={styles.a_bold} href="/nonsul/med">
                                            의치대 논술
                                        </a>
                                    </li>
                                    {/* <li>
                                <a href='/nonsul/low'>약식 논술</a>
                            </li> */}
                                </ul>
                            </div>
                        </UserAgent>
                        <div id={styles.discuss_contents}>
                            ...
                            <div className={styles.page}>
                                ...
                                <button
                                    className={`${styles.btn} ${page == pageTitles.length - 1 ? styles.btn_disabled : styles.btn_active}`}
                                    onClick={onNext}
