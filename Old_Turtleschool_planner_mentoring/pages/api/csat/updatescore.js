...
export default async (req, res) => {
    ...
    if (req.method == 'POST') {
    		...
    		await pool.query(`update csatuscore
            ...
            ,[req.headers.auth, req.body.data[i].score_convert_a, req.body.data[i].score_convert_b, 
              req.body.data[i].year, req.body.data[i].score])
				}
		}
