...
export default async (req, res) => {
    ...
    let s_collegeinterest = req.query.collegeinterest;
...
*/
              ...
              c2.add70cuts_score ,c2.addcumulativetop  `,
                    [req.headers.auth, s_division, s_year, s_universitynm, s_departmentnm, s_collegeinterest, s_recruitment, s_areacode, s_cross_sprt]
                );
