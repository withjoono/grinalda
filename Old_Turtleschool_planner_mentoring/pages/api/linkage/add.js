...
export default async (req, res) => {
    ...
    const myid = rows[0].id;
	  ...
	  await pool.query(`insert into accountlinks values ($1,$2) on conflict do nothing`,[req.headers.auth,id])



    await pool.query(`insert into adminclass (memberid , memberid2 , useyn , fsrdtm , lshdtm , groupid, groupname )
