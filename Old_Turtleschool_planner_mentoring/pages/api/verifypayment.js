...
export default async (req, res) => {
    try {
        const { imp_uid, merchant_uid, uid } = req.body; // req의 body에서 imp_uid, merchant_uid 추출
        ...
        if (amount === amountToBePaid) {
            ...
            await axios({
                ...
                method: 'post', // POST method
                headers: { 'Content-Type': 'application/json', Authorization: access_token }, // "Content-Type": "application/json"
                data: {
                    reason: '위조된 결제시도',
                    imp_uid: imp_uid,
                },
