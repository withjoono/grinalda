     ...
     input[type=reset   ]{
        ...
        <div className="line"></div>
            <div className="turm">
                ...
                <div className="send">
                    <input type="submit"value="완료" onClick={() => submit('40')}/>
...
const Mobile = ({history}) => {
	...
	schools, setSchools, locations, year, setYear,setName, setPhoneFull, privacy, setPrivacy, location, setLocation,
	grade, setGrade,submit} = useForm()
    return(
        <>
			<style jsx>{`
   ...
   <section className="name">
	...
	<section className="join" onClick={() => submit('40',true)}><button>회원가입 완료</button></section>
		</>
    );
}
