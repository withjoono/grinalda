	...
	return(
        ...
        input[type=reset   ]{
            ...
            <div className="grade">
                <p>학년</p>
                <p>졸업 예정 연도</p>
                <select name="" className="gradeBox1" value={grade} onChange={setGrade}><option value=''>학년 선택</option><option value='H1'>1학년</option><option value='H2'>2학년</option><option value='H3'>3학년</option><option value='HN'>N수생</option></select>
                <input type="number" name="" className="gradeBox2" value={year} onChange={setYear}/>
            </div>
            <div className="grade">
                <p>지역</p>
                <p>출신고교</p>
            ...
            <div className="turm">
               ...
               <span><input type="radio" name="agree" id="" value={1} onClick={setPrivacy} checked={privacy == 1}/>1년</span>
                ...
                <div className="send">
                    <input type="submit"value="완료" onClick={() => submit('10')}/>
...
const Mobile = () => {
	const {login, user} = React.useContext(loginContext);
	const {name,phoneFull,email, setEmail, highschool, setHighschool, setSchoolLocation,
	schools, setSchools, locations, year, setYear,setName, setPhone, setPhone1, setPhone2, privacy, setPrivacy, location, setLocation,
	grade, setGrade, submit, setPhoneFull} = useForm()
    const thematic = {
		container: {
			width:'229px',
            height:'56px',
	...
	return(
        ...
        .join button{
			...
			<section className="join" onClick={() => submit('10',true)}><button>회원가입 완료</button></section>
		</>
    );
}
