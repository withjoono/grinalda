        ...
        <div className="content">
            ...
            <div className="border">
                ...
                <div className="right">
                    ...
                    <p>유</p>/<p>무</p><p>면접날짜</p><p>2021.10.23</p>
                    </div>
                    <div className="interview">
                        <p>유</p>/<p>무</p><button>면접날짜 종목확인</button>
                    </div>
        ...
        <div className="content">
            <div className="select">
                <div className="buttons">
                    <button className = {onButton == 0 ? 'onButton' : ''} onClick = {()=> setOnButton(0)}>교과</button>
                    <button className={onButton == 1 ? 'onButton' : ''}onClick = {()=> setOnButton(1)}>학생부 종합</button>
                    <button className={onButton == 2 ? 'onButton' : ''}onClick = {()=> setOnButton(2)}>논술</button>
                </div>
                <h1>대학별 교과 합격 분포</h1>
                ...
                <div className="find">
                    ...
                    <div className="border"><p>수학과</p><button onClick={()=> setClick(true)}>상세검색</button></div>
                    <div className="border"><p>국어국문학과</p><button onClick={()=> setClick(true)}>상세검색</button></div>
                    <div className="border"><p>유아교육과</p><button onClick={()=> setClick(true)}>상세검색</button></div>
                    <div className="border"><p>영어교육과</p><button onClick={()=> setClick(true)}>상세검색</button></div>
                    <div className="border"><p>간호학과</p><button onClick={()=> setClick(true)}>상세검색</button></div>
                    </div>
                </div>
                <h1>학과 찾기</h1>
                <div className="find">
