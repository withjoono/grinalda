...
const SimulatedTest = () => {
    ...
    useEffect(() => {selectgrapsubject(subject)},[switchb,switchc])
	...
	const SelectExamTest = (e) => {
		...
		}).then(res => { console.log('gra'); console.log(res.data);
        ...
        let tickamount = 0;
			...
			if(switchb == 'K')
			{
                ...
                if(switchc == 'P'){
                    ...
                    tickamount = 4;
                    arr_score = param.map(obj => {
                        return (obj.korea_standardscore * 1.00
                        )}) ;
                    console.log(arr_score)
                }
			 }
			else if(switchb == 'E')
			{
                if(switchc == 'P'){
                    ...
                    tickamount = 4;
                    arr_score = param.map(obj => {
                        return (obj.english_standardscore * 1.00
                        )}) ;
                }
			 }
			else if(switchb == 'M')
			{
                if(switchc == 'P'){
                    ...
                    tickamount = 9;
                    arr_score = param.map(obj => {
						return {y: (obj.math_grade * 1.00 % 9
						) || 9, low: 9}}) ;
                }
                else if (switchc=='O'){
                    mindata = 0;
                    ...
                    tickamount = 4;
                    arr_score = param.map(obj => {
                        return (obj.math_standardscore * 1.00
                        )}) ;
                }
			 }
             if(switchb == 'A')
             {
                if(switchc == 'P'){
                    ...
                    tickamount = 4;
                    arr_score = param.map(obj => {
                        return (obj.soc_standardscore * 1.00
                        )}) ;
                }
              }
			setGrapSubjec({
        ...
        <div className="content">
            ...
            <div className="graph1">
                ...
                <div className="menu">
                    <ul>
                        <li>지수 점수</li>
                        <li className='P' onClick={(e) => setSwitcha("P")}>표준</li>
                        <li className='G'onClick={(e) => setSwitcha("G")}>등급</li>
                        <li className='O' onClick={(e) => setSwitcha("O")}>백분위</li>
                    </ul>
                </div>
                <div className="box">
