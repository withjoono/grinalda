		...
		`}</style>
            ...
            <div className="compliance">
                ...
                <table>
					...
					{!compliance.length ? <tr><td>1</td><td>-</td></tr> : null}
                    {compliance.map((n,i) => <tr><td>{i+1}</td><td>{n.rmk}</td></tr>)}
                </table>
                <div className="radio">
                    <div></div>
                    <div></div>
            ...
            <div className="notice">
                ...
                <table>
					...
					{!question.length ? <tr><td>1</td><td>-</td></tr> : null}
                    {question.map((n,i) => <tr><td>{i+1}</td><td>{n.rmk}</td></tr>)}
            ...
            <div className="notice">
                ...
                <table>
					...
					{!notice.length ? <tr><td>1</td><td>-</td></tr> : null}
                    {notice.map((n,i) => <tr><td>{i+1}</td><td>{n.rmk}</td></tr>)}
			 ...
			 <div className="notice">
                ...
                <table>
					...
					{!oprtnPrncp.length ? <tr><td>1</td><td>-</td></tr> : null}
                    {oprtnPrncp.map((n,i) => <tr><td>{i+1}</td><td>{n.rmk}</td></tr>)}
