    ...
    return (
        <div className="contaner">
            ...
            <div className="header">
                <h1>플래너 검사</h1>
                <div className="btn">
                    <Link href="/myclass_free/home">
                        <input type="button" value="마이클래스 홈" />
                    </Link>
                    <Link href="/myclass_free/planner">
                        <input type="button" value="플래너검사" />
                    </Link>
                    <Link href="/myclass_free/schoolgrades">
                        <input type="button" value="내신관리" />
                    </Link>
                    <Link href="/myclass_free/simulatedtest">
                        <input type="button" value="모의고사 관리" />
                    </Link>
                    <Link href="/myclass_free/test">
                        <input type="button" value="테스트" />
                    </Link>
                    <Link href="/myclass_free/health">
                        <input type="button" value="체력검사" />
                    </Link>
                </div>
            </div>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <td className="list-start">자체시험</td>
                                        <td className="list-start">체력검사</td>
                                        <td className="list-start">합계</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    {daylist != undefined &&
                                        daylist.map((obj) => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td className="list-section">{obj['testscores']}</td>
                                                    <td className="list-section">{obj['ftnsscore']}</td>
                                                    <td className="list-section">{obj['totalscore']}</td>
                                                </tr>
                                            );
                                        })}
                                </tbody>
...
export default withDesktop(Planner, page, null, '플래너');
