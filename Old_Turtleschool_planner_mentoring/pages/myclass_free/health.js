            ...
            <div className="content">   
                ...
                <div className="third">
                    ...
                    <div className="left">
                        ...
                        <div className="box">
                            <HighchartsReact highcharts={Highcharts} options={chartsitups} allowChartUpdate={true} />
                        </div>
                    </div>
                    <div className="right">
                        <table>
                ...
                <div className="third">
                    ...
                    <div className="left">
                        ...
                        <div className="box">
                            <HighchartsReact highcharts={Highcharts} options={chartpushups} allowChartUpdate={true} />
                        </div>
                    </div>
                    <div className="right">
                    <table>
