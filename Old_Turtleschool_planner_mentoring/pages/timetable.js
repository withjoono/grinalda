                    ...
                    .map((d, i) => {
                        return (
                            <div key={'key' + i} className={s.flex} style={{ alignItems: 'center' }}>
                                <SubjectListItem onDeleteClick={onDeleteClick} data={d} style={{ width: 0, flex: '1 0 0' }} setEditingTarget={setEditingTarget} setFormVisible={setFormVisible} setType={setType} />
                            </div>
                        );
                    })}
            </div>
