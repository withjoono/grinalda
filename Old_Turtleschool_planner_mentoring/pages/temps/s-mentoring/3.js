...
const sMentoring3 = () => {
    return (
        <SideNavPage
            ...
            <div style={{width:'1030px', height:'1830px', border:'1px solid lightgray'}}>
                <img src='/assets/temp_img/sMentoring/3-1.png' style={{height:'auto', width:'1020px'}} />
                <img src='/assets/temp_img/sMentoring/3-2.png' style={{height:'auto', width:'1020px'}} />
                <img src='/assets/temp_img/sMentoring/3-3.png' style={{height:'auto', width:'1020px'}} />
            </div>
        </SideNavPage>
    );
}
