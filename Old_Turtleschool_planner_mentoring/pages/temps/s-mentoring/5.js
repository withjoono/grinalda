...
const sMentoring3 = () => {
    return (
        <SideNavPage
            ...
            <div style={{width:'1030px', height:'790px', border:'1px solid lightgray'}}>
                <img src='/assets/temp_img/sMentoring/5-1.png' style={{height:'auto', width:'1020px'}} />
            </div>
        </SideNavPage>
    );
}
