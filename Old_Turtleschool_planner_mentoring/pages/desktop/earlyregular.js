...
import EarlyInput from '../early/graph'
const EarlyRegular = () => {
	...
	return (<div style={{backgroundColor:'#FAFAFA'}}>
		...
		<div style={{width:'1280px',margin:'0 auto'}}>
			...
			<div style={{backgroundImage:`url('/assets/test-illustration.png')`, backgroundRepeat:'no-repeat',backgroundPosition:'right',minHeight:'300px',width:'860px',margin:'0 auto',display:'flex',alignItems:'center'}}>
			<div>
				<span className='title_left'>정시 가능 대학</span>
				<p>
				정시 가능 대학 검색은 모의고사/성적 관리에서<br/>
				성적 입력 후 확인하실 수 있습니다.
				</p>
				</div>
			</div>
