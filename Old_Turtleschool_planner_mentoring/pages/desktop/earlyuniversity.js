...
const EarlyRegular = () => {
	...
	return (<div style={{backgroundColor:'#FAFAFA'}}>
		...
		<div style={{width:'1280px',margin:'0 auto'}}>
			...
			<div className='menu'>
				{
					['교과 전형','학생부 종합 전형','논술 전형'].map((e,i) => <button value={i} className={chosen == i ? 'menu_active' : ''} onClick={handleClick}>{e}</button>)
				}
			</div>
			<div style={{height:'30px',width:'100%'}}/>
			...
			<div className='desktop_box' style={{height:'656px'}}>
			</div>
