        ...
        <div className='page' style={{ backgroundColor: '#f5f6f8' }}>
            ...
            <div className={container}>
                <div className={account}>
					...
					<div onClick={onRemoveAccountClick} className={text}>회원 탈퇴</div>
                </div>
                ...
                <div className={info}>
                    ...
                    <Link href='/desktop/businessinfo'>
                ...
                <div className={push}>
                    ...
                    <div className={text} style={{ display: 'flex', justifyContent: 'space-between' }}>
                        마케팅 푸시 및 수신 동의
                        <div onClick={handleChange} style={{ width: '55px', height: '22px', borderRadius: '11px', backgroundColor: '#e2e2e2', position: 'relative' }}>
                            <div style={{ position: 'absolute', top: 0, left: 0, backgroundColor: `${ctx.push[0] ? '#fede01' : '#707070'}`, width: '22px', height: '22px', borderRadius: '11px', transform: `${ctx.push[0] ? 'translateX(33px)' : 'translateX(0)'}`, transition: 'transform 0.6s' }} />
                        </div>
                    </div>
                </div>
            </div>
