    ...
    const contents = [
        {
            ...
            src: "/assets/icons/winter_program/fluent_person-chat-24-regular@3x.png",
        },
        {
            label: "수시파이터를 위한",
            title: "플래너 + 생기부 관리반",
            ...
            src: "/assets/icons/winter_program/icon-park-outline_doc-success@3x.png"
        },
        {
            label: "방학 학습 관리를 위한",
            title: "온종일 화상관리 + 클리닉반",
            ...
            src: "/assets/icons/winter_program/fluent_video-person-16-regular@3x.png"
        }
    ]
