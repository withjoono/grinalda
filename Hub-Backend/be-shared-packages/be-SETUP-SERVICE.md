...
cd /path/to/Hub-Backend/shared-packages
...
{
  "dependencies": {
    "@geobuk/shared-types": "file:../Hub-Backend/shared-packages/packages/types",
    "@geobuk/shared-entities": "file:../Hub-Backend/shared-packages/packages/entities",
    "@geobuk/common-utils": "file:../Hub-Backend/shared-packages/packages/utils"
  }
}
```
