...
> **대상**: Hub-Backend에 통합될 분리 개발 프로젝트 (플래너 등)
> **버전**: 1.0.0
> **최종 수정**: 2024-12
...
이 문서는 Hub-Backend(메인 백엔드)에 통합될 분리 개발 프로젝트가 따라야 할 표준을 정의합니다.

### 통합 흐름

```
┌─────────────────┐     통합      ┌─────────────────────────────┐
│  분리 프로젝트   │ ──────────→ │  Hub-Backend (메인 백엔드)   │
...
**관련 문서**:
- [Hub-Backend CONTRIBUTING.md](../CONTRIBUTING.md)
