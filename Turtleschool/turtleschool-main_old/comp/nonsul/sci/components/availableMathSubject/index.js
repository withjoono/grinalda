  ...
  const renderUnivItem = univ => (
    <tr key={univ.university} className={cx('t_br', 't_bb', 't_bl')}>
      ...
      <td className={cx('checkbox')}>
        <input
          checked={firstSciUnivCode.includes(univ.university)}
          type="checkbox"
          id={univ.university}
          name="선택"
    ...
    <div id={styles.contents}>
      <div id={styles.discuss}>
        <div id={styles.discuss_contents}>
          <Advice>
            * 수리논술 출제 범위가 대학별로 상이합니다. <br></br>* 본인이 가능한 수학 과목을
            선택해주세요. <br></br>  * 의치한수약대는 좌측메뉴에 의치대논술을 참조해주세요.
          </Advice>
                    ...
                    <td className={cx('filter_container')}>
                      <div style={{display: 'flex', flexDirection: 'row'}}>
                        <button
                          ...
                          className={cx(
                            'check',
                            filter.math ? 'c_orange' : ['c_gray_02', 'b_gray_06'],
                          )}
                        >
                          수1,수2
                        </button>
                        <button
                          ...
                          className={cx(
                            'check',
                            filter.statistics ? 'c_orange' : ['c_gray_02', 'b_gray_06'],
                          )}
                        >
                          확통
                        </button>
                        <button
                          ...
                          className={cx(
                            'check',
                            filter.algebra ? 'c_orange' : ['c_gray_02', 'b_gray_06'],
                          )}
                        >
                          미적
                        </button>
                        <button
                          ...
                          className={cx(
                            'check',
                            filter.geometry ? 'c_orange' : ['c_gray_02', 'b_gray_06'],
                          )}
                        >
                          기하
                        </button>
...
AvailableMathSubject.propTypes = {
