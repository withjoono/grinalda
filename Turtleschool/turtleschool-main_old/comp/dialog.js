...
const Dialog = props => {
  ...
  return (
    <Dia open={open} onClose={handleClose} classes={{paper: classes.container}} fullWidth={true}>
      <div>
        <div style={titlestyle}>{title ? title : '로그인 후 서비스 이용이 가능합니다.'}</div>
        ...
        {!!vertical || !buttons ? (
          <>
            <div
              style={{...buttonstyle, backgroundColor: '#dddddd'}}
              onClick={() => {
                handleClose(1);
              }}
            >
            ...
            <div
              style={{...buttonstyle, backgroundColor: '#fede01'}}
              onClick={() => {
                handleClose(2);
              }}
            >
