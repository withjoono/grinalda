...
const grade = props => {
    ...
    if (submitted) {
      ...
      for (var key in info) {
        if (info[key] != null && info[key].subjectCode) {
          ...
          if (
            info[key].originScore ||
            info[key].standardScore ||
            info[key].percentScore ||
            info[key].grade
          ) {
  ...
  const addInfo = e => {
    ...
    if (
      dataType == 'originScore' &&
      cpy[name]['subjectCode'] &&
      conv[cpy[name]['subjectCode']] &&
      conv[cpy[name]['subjectCode']][value]
    ) {
  ...
  return (
    <div style={{position: 'relative'}}>
      ...
      `}</style>
      {disabled ? <div className="disabled">조건을 선택해주세요</div> : null}
      <table>
        <tr>
          <th>과목</th>
        ...
        <tr>
          <td>
            <div className="subject">
              {grade == 3 ? (
                <select
                  data-type="subjectCode"
                  name={'kr'}
                  onChange={updateKr}
                  value={info['kr'] ? info['kr'].subjectCode : '0'}
                >
          ...
          {type != 0 ? (
            <td>
              <input
                className="input"
                name={'kr'}
                data-type="originScore"
                value={info['kr'] ? info['kr'].originScore || '' : ''}
                onChange={updateKr}
                placeholder="입력"
              />
            </td>
          ...
          <td>
            <input
              className="input"
              name={'kr'}
              data-type="standardScore"
              value={info['kr'] ? info['kr'].standardScore || '' : ''}
              onChange={updateKr}
              placeholder="입력"
            />
          </td>
          <td>
            <input
              className="input"
              name={'kr'}
              data-type="percentScore"
              value={info['kr'] ? info['kr'].percentScore || '' : ''}
              onChange={updateKr}
              placeholder="입력"
            />
          </td>
        ...
        <tr>
            ...
            <div className="subject">
              {grade == 3 ? (
                <select
                  ...
                  name={'ma'}
                  onChange={update}
                  value={info['ma'] ? info['ma'].subjectCode : '0'}
                >
                  <option disabled value="0" disabled selected>
                    수학
                  </option>
          ...
          {type != 0 ? (
            <td>
              <input
                ...
                name={'ma'}
                data-type="originScore"
                value={info['ma'] ? info['ma'].originScore || '' : ''}
                onChange={updateMath}
                placeholder="입력"
              />
            </td>
          ...
          <td>
            <input
              ...
              name={'ma'}
              data-type="standardScore"
              value={info['ma'] ? info['ma'].standardScore : ''}
              onChange={updateMath}
              placeholder="입력"
            />
          </td>
          <td>
            <input
              ...
              name={'ma'}
              data-type="percentScore"
              value={info['ma'] ? info['ma'].percentScore : ''}
              onChange={updateMath}
              placeholder="입력"
              placeholder="입력"
            />
        ...
        <tr>
          ...
          {type != 0 ? (
            <td>
              <input
                ...
                name={'en'}
                data-type="originScore"
                value={info['en'] ? info['en'].originScore || '' : ''}
                onChange={update}
                placeholder="입력"
              />
            </td>
          ...
          <td>
            <input
              ...
              name={'en'}
              data-type="standardScore"
              value={info['en'] ? info['en'].standardScore || '' : ''}
              onChange={update}
              placeholder="-"
            />
          </td>
          <td>
            <input
              ...
              name={'en'}
              data-type="percentScore"
              value={info['en'] ? info['en'].percentScore || '' : ''}
              onChange={update}
              placeholder="-"
            />
          </td>
        ...
        <tr>
            ...
            <div className="subject">
              {grade > 1 ? (
                <select
                  ...
                  name={'r1'}
                  onChange={update}
                  value={info['r1'] ? info['r1'].subjectCode : '0'}
                >
                  ...
                  {studies.map((e, i) => {
                    if (
                      grade == 2 &&
                      parseInt(subjectcode[e]) > 24 &&
                      parseInt(subjectcode[e]) < 30
                    )
                      return;
                    return (
                      <option key={i} value={subjectcode[e]}>
                        {e}
                      </option>
                    );
                  })}
          ...
          {type != 0 ? (
            <td>
              <input
                ...
                name={'r1'}
                data-type="originScore"
                value={info['r1'] ? info['r1'].originScore || '' : ''}
                onChange={update}
                placeholder="입력"
              />
            </td>
          ...
          <td>
            <input
              ...
              name={'r1'}
              data-type="standardScore"
              value={info['r1'] ? info['r1'].standardScore : ''}
              onChange={update}
              placeholder="입력"
            />
          </td>
          <td>
            <input
              ...
              name={'r1'}
              data-type="percentScore"
              value={info['r1'] ? info['r1'].percentScore : ''}
              onChange={update}
              placeholder="입력"
            />
          </td>
        ...
        <tr>
            ...
            <div className="subject">
              {grade > 1 ? (
                <select
                  ...
                  name={'r2'}
                  onChange={update}
                  value={info['r2'] ? info['r2'].subjectCode : '0'}
                >
                  <option disabled value="0">
                    탐구2
                  </option>
          ...
          {type != 0 ? (
            <td>
              <input
                ...
                name={'r2'}
                data-type="originScore"
                value={info['r2'] ? info['r2'].originScore || '' : ''}
                onChange={update}
                placeholder="입력"
              />
            </td>
          ...
          <td>
            <input
              ...
              name={'r2'}
              data-type="standardScore"
              value={info['r2'] ? info['r2'].standardScore : ''}
              onChange={update}
              placeholder="입력"
            />
          </td>
          <td>
            <input
              ...
              name={'r2'}
              data-type="percentScore"
              value={info['r2'] ? info['r2'].percentScore : ''}
              onChange={update}
              placeholder="입력"
            />
          </td>
        ...
        <tr>
          ...
          {type != 0 ? (
            <td>
              <input
                ...
                name={'hi'}
                data-type="originScore"
                value={info['hi'] ? info['hi'].originScore || '' : ''}
                onChange={update}
                placeholder="입력"
              />
            </td>
          ...
          <td>
            <input
              ...
              name={'hi'}
              data-type="standardScore"
              value={info['hi'] ? info['hi'].standardScore || '' : ''}
              onChange={update}
              placeholder="-"
            />
          </td>
          <td>
            <input
              ...
              name={'hi'}
              data-type="percentScore"
              value={info['hi'] ? info['hi'].percentScore || '' : ''}
              onChange={update}
              placeholder="-"
            />
          </td>
