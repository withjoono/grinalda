  ...
  return (
    ...
    >
      <div style={{width: '1030px', height: '1750px', border: '1px solid lightgray'}}>
        <img
          src="https://img.ingipsy.com/assets/temp_img/sMentoring/2-1.png"
          style={{height: 'auto', width: '1020px'}}
        />
        <img
          src="https://img.ingipsy.com/assets/temp_img/sMentoring/2-2.png"
          style={{height: 'auto', width: '1020px'}}
        />
        <img
          src="https://img.ingipsy.com/assets/temp_img/sMentoring/2-3.png"
          style={{height: 'auto', width: '1020px'}}
        />
      </div>
    </SideNavPage>
