...
const sMentoring3 = () => {
  return (
    ...
    >
      <div style={{width: '900px', height: '760px', border: '1px solid lightgray'}}>
        <img
          src="https://img.ingipsy.com/assets/temp_img/sMentoring/4-1.png"
          style={{height: 'auto', width: '895px'}}
        />
      </div>
    </SideNavPage>
  );
