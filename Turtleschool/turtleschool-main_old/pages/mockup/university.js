  ...
  const getRange = (min, max) => {
    ...
    return (
      <>
        <style jsx>{`
          div {
            background: transparent linear-gradient(180deg, #d8dc6a 0%, #fd8492 100%) 0% 0%
  ...
  return (
    <div style={{width: '90%', margin: '20px auto', position: 'relative'}}>
      <div className="mobile_menu" onClick={e => setType(e.target.value)}>
        <button className={type == 0 ? 'mobile_menuactive' : ''} value={0}>
          대학별 검색
        </button>
        <button className={type == 1 ? 'mobile_menuactive' : ''} value={1}>
          학과별 검색
        </button>
      </div>
      <style jsx>
      ...
      </style>
      {
        type == 0 ? ( // 대학별 검색
          <>
            ...
            <div className="orangebigbtn" onClick={search}>
              검색하기
            </div>
            ...
            <div className="univ">
              {data.map(d => (
                <button
                  className={chosen == d[3] ? 'univ_active' : ''}
                  value={d[3]}
                  onClick={click}
                >
                  {d[2]}
          ...
          <>
            ...
            <div className="orangebigbtn" onClick={searchTwo}>
              검색하기
            </div>
            <div className="divider" />
            <table className="tbl">
