...
function MyApp({Component, pageProps}) {
    ...
    axios
      ...
      .then(res => {
        if (res.data.success === true) {
          console.log('성적 받아왔음', res);
          setUserScore(res.data.data);
        } else {
          console.log('성적 못 받아왔음', res);
        }
      });
  };
  ...
  //   if (
  //     router.pathname === '/regular/scoreInput' ||
  //     router.pathname === '/regular/firstConsulting' ||
  //     router.pathname === '/regular/secondConsulting' ||
  //     router.pathname === '/regular/thirdConsulting' ||
  //     router.pathname === '/regular/analyse' ||
  //     router.pathname === '/regular/univOfInterest'
  //   ) {
  //     return (
  ...
  //             <Layout>
  //               <Component {...pageProps} loginInfo={loginInfo} userScore={userScore} />
  //             </Layout>
  //           </Opt.Provider>
  //         </Provider>
  //       </QueryClientProvider>
