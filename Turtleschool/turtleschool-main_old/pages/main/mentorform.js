        ...
        <div className="information">
          ...
          <div className="phone">
            ...
            <div className="selectBox">
              <select name="" id="" value={phone} onChange={setPhone}>
          ...
          <div className="grade">
            <p>지역</p>
            <p>출신고교</p>
            <select name="" className="gradeBox1" onChange={setLocation} value={location}>
 ...
 * {
      ...
      <section className="join" onClick={() => submit('70', true)}>
