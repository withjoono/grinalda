...
import desktop from '../desktop/earlyjungsi-predict';
import s from '../mockup/inputchoice.module.css';
  ...
  return (
    <div className="page" style={{color: '#2d2d2d'}}>
      <div style={{padding: '20px'}}>
        <div style={{fontSize: '1.2em', margin: '1em 0'}} className={s.bold}>
        ...
        <div className={s.select}>
          <Link href="/mockup/gradeinput" passHref>
            <button
              onClick={() => {
          ...
          <Link href="/mockup/omrinput" passHref>
            <button
              onClick={() => {
                sessionStorage.setItem('type', examtype);
                sessionStorage.setItem(
