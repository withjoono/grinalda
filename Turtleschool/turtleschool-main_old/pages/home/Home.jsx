...
const Home = () => {
  ...
  return (
    <div style={{width: '100%', overflow: 'hidden', position: 'relative'}}>
      ...
      <QuickMenu />
      <AppBorderWrapper />
      <img width="100%" src="https://img.ingipsy.com/assets/main_banner/mobile_main_analysis.png" />
      <div style={{width: '100%'}}>
        <iframe
          width="100%"
          height="295px"
      ...
      <img width="100%" src="https://img.ingipsy.com/assets/main_banner/mobile_main_jungsi.png" />
      <WinterProgram />
      <MentorList />
      {/* <Suggestion /> */}
    </div>
...
const MentorList = () => {
  ...
  const renderMentorContent = mentor => (
    <MentorContainer>
      ...
      <MentorImage src={'https://img.ingipsy.com/profile-img/' + mentor.img + '.jpg'} />
...
const Suggestion = () => {
  ...
  return (
    <Container>
      ...
      <SuggestImage
        src="https://img.ingipsy.com/assets/main_banner/main_suggest1.png"
        onClick={() => (window.location.href = '/gpa/mygrade/')}
      />
      <SuggestImage
        src="https://img.ingipsy.com/assets/main_banner/main_suggest2.png"
        onClick={() => (window.location.href = 'https://www.turtleschool.kr/z/')}
      />
      <SuggestImage
        src="https://img.ingipsy.com/assets/main_banner/main_suggest3.png"
        onClick={() => (window.location.href = '/gpa/graph/')}
      />
    </Container>
  );
};
