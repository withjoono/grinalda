    ...
    <div className="wrap">
      ...
      <div className="contain">
        ...
        <div className="list_menu">
          <div className={list == 0 ? 'student_af' : 'student_be'} onClick={() => setList(0)}>
            학생
          </div>
          <div className={list == 1 ? 'ment_af' : 'ment_be'} onClick={() => setList(1)}>
            {' '}
            선생님{' '}
          </div>
        </div>
                ...
                <div className="profile">
                  <div className="profile_right">
                    <div className="text">
                      ...
                      <p style={{fontSize: '24px', fontWeight: 'bold'}}>{subString(f.join_date)}</p>
                    </div>
                  </div>
                </div>
              </div>
