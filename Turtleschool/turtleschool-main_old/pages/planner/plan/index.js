...
import {useLoginCheck} from '../../../src/hooks/useLoginCheck.js';
import s from './timetable.module.css';
//import SideNavPage from '../../../comp/templatePage';
        ...
        <Scheduler data={data} locale="ko-kr" height={800}>
          ...
          <Plugin dependencies={pluginDependencies} name="IntegratedDates">
            ...
            <AppointmentForm
              ...
              /* commandButtonComponent={Command} */ basicLayoutComponent={Layout}
