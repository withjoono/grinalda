...
const SchoolGrades = () => {
  ...
  const selectExam1 = e => {
    ...
    axios
      ...
      .then(res => {
        ...
        changeGrpSemester1(res.data.data);
      });
  };
  ...
  const selectExam2 = e => {
    ...
    axios
      ...
      .then(res => {
        setSemester2(res.data.data);
        changeGrpSemester2(res.data.data);
      });
  };
  ...
  const selectExam3 = e => {
    axios
      ...
      .then(res => {
        changeGrpSemester3(res.data.data);
      });
  };
      ...
      <div className="content">
          ...
          <div className="left">
            ...
            <div className="menu">
              <ul>
                ...
                <li>지수선택</li>
                <li onClick={() => UpdateTopSwitch('L')}>내신 등급</li>
                <li onClick={() => UpdateTopSwitch('R')}>편차 지수 등급</li>
              </ul>
            </div>
          ...
          <div className="left">
            ...
            <div className="menu">
              <ul>
                ...
                <li>지수선택</li>
                <li onClick={() => UpdateDownSwitch('L')}>내신 등급</li>
                <li onClick={() => UpdateDownSwitch('R')}>편차 지수 등급</li>
              </ul>
            </div>
            <div className="box">
              <div className="num">
        ...
        <div className="third">
          ...
          <select name="" id="" value={memberid} onChange={handleChangeId}>
            {members?.map(option => (
              <option key={option.id} value={option.id} name={option.user_name} defaultValue={''}>
                {option.user_name}
              </option>
            ))}
          </select>
