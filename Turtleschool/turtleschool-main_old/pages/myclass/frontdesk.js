            ...
            <div className="text">
              <div style={{padding: '10px'}}>
                <div className="">
                  ...
                  매달 말일 경, 반 이동을 신청할 수 있습니다. 이때 반을
                  <br></br>
                  이동할 수 있습니다 단 레벨이 다른 반으로 월반을 원할 경우엔
                  <br></br>반 이동 허가가 나야 반이동을 할 수 있습니다
                </div>
                <div className="">
                  <div style={{fontSize: '26px', fontWeight: 'bold'}}>
                    2. 플래너 평가 점수와 테스트 결과 공개 원칙<br></br>
                  </div>
                  - 플래너관리반의 학생은 서로의 동기부여를 위해서<br></br>
                  플래너 평가 점수는 공개를 원칙으로 합니다.<br></br>
                  하지만, 내신 성적이나 모의 성적 등은 누구의 성적인지 알 수 없도록 이름을 00처리를
                  해서<br></br>
                  공개합니다
                </div>
                <div className="">
                  <div style={{fontSize: '26px', fontWeight: 'bold'}}>3. 수업료</div>- 수업료는
                  시작하는 날로 부터 월단위로 정산합니다
                </div>
                <div className="">
                  <div style={{fontSize: '26px', fontWeight: 'bold'}}> 4. 환불</div>- 환불 원칙은
                  교육청 환불 규정을 따릅니다.<br></br>
        ...
        */}
        <div className="foure">
          ...
          <div className="text" style={{padding: '20px'}}>
            ...
            >
              2. 멘토쌤이 플래너를 매일 검사할 수 있도록<br></br> 플래너는 매일 작성하고<br></br>{' '}
              성취도도 매일 기재해야 합니다
            </div>
            <div
              className=""
            ...
            >
              3. 3회 결격사유일땐 퇴소이며<br></br> 남은 잔여일 수업에 대한 환불은 없습니다.{' '}
            </div>
            <div
              className=""
              style={{
            ...
            >
              4. 멘토쌤과 주당 최소 1회는 테스트를 보며<br></br> 그 성적은 마이클래스 플래너관리반에
              공개합니다
            </div>
          </div>
        </div>
...
export async function getStaticProps() {
  const {rows} =
    await pool.query(`select comn_grp_cd , comn_cd, comn_nm, comn_grp_nm, useyn , sort ,
    lar_cd , mid_cd , sml_cd
		 from commoncode where comn_grp_cd = 'P00004'`);
