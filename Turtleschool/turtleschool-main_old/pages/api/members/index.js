  ...
  switch (req.method) {
    ...
    case 'GET':
      ...
      , c.id as childId
			...
			,	c.parentid
      , (select "소재지명" from highschool_csv where 학교명 = c.school) as childRegion
      , m.candnumber
    ...
    case 'POST':
      ...
      switch (req.body.relationCode) {
        ...
        case '20':
          ...
          await req.body.children.map(async d => {
            ...
            if (d.id === '') {
              await pool.query(
                `insert into children(parentid, name, grade, year, school)
                 values($1,$2,$3,$4,$5)`,
                [id, d.name, d.grade, d.year, d.highschool],
              );
            } else {
              await pool.query(
                `update children
               ...
               where id = $1         
               `,
                [d.id, d.name, d.grade, d.year, d.highschool],
              );
            }
          });
          break;
        case '40':
          results = await pool.query(
            ...
            SET     user_name       =   $2
                ...
                ,   "updateDate"    =   timezone('utc'::text, now())
                    WHERE   id          =   $1`,
            [memberId, req.body.userName, req.body.cellphone, req.body.email, req.body.prsnlInprd],
          );
          break;
        case '70':
          results = await pool.query(
      ...
      break;
    case 'DELETE':
      let result = await pool.query(`delete from members where id=$1`, [memberId]);
      success = true;
