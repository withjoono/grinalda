...
const regularbeneficial = () => {
  return (
    ...
    >
      ...
      `}</style>
      <Menu index={0} title={"전략수립 및 모의지원"}/>
      <div className="page">
        <div className="contain">
          <div className="bigtitle1">관심 대학</div>
          <div className="school">
            ...
            <table>
              ...
              <tr>
                ...
                <td>2020.10.23</td>
                <td>
                  <img src="https://img.ingipsy.com/assets/icons/Icon_checkbox_none.png"></img>
                </td>
              </tr>
              <tr>
                <td>
...
{/*           <div className="bigtitle2">모의 지원</div>
          ...
          <Buttons prevPage='' nextPage='strategy' />
        </div>
      </div>
    </SideNavPage>
    </>
