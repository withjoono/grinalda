...
const Chart = ({data, labels, title, subtitle, oneToOne, chosen}) => {
  ...
  return (
    <HighchartsReact ref={ref} highcharts={Highcharts} options={options} allowChartUpdate={true} />
  );
};
      ...
      <div className="page">
        ...
        <div style={{width: '1280px', margin: '0 auto'}}>
          <div className="menu" onClick={handleSwitch}>
            <button id="sum" className={left ? 'menu_active' : 'menu_inactive'}>
              조합별
            </button>
            <button id="individual" className={!left ? 'menu_active' : 'menu_inactive'}>
              과목별
            </button>
          </div>
          ...
          <div className="types">
            <div>지수 선택</div>
            <button
              className={scoreType == 1 ? 'white_txt orange' : ''}
              onClick={() => {
                setScoreType('1');
              }}
            >
            ...
            <button
              className={scoreType == 2 ? 'white_txt orange' : ''}
              onClick={() => {
                setScoreType('2');
              }}
            >
            ...
            <button
              className={scoreType == 3 ? 'white_txt orange' : ''}
              onClick={() => {
                setScoreType('3');
              }}
            >
