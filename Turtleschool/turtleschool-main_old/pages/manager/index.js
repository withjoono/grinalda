...
import {postData} from '../../comp/data';
  ...
  return (
    <>
      ...
      <div className="content">
                ...
                <div className="a_class" name="a_clas">
                  {edit == false ? (
                    <div className="nameBox">
                      {myclass &&
                        myclass.length > 0 &&
                        myclass
                          .filter(e => e.groupname == ob.groupname)
                          .map(obj => {
                            return (
                              <tr>
                  ...
                  {member == true ? (
                    <>
                      ...
                      >
                        <div onClick={() => dropChange()}>
                          <img src="https://img.ingipsy.com/assets/icons/more_after.png"></img>
                        </div>
                    ...
                    <>
                      ...
                      >
                        <div onClick={() => dropChange()}>
                          <img src="https://img.ingipsy.com/assets/icons/more_before.png"></img>
                        </div>
        ...
        <div className="plus">
          <button className="plus" name="classAdd" onClick={handleAAdd}>
            +연동하기
          </button>
        </div>
      </div>
