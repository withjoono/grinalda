...
export const PrivacyPolicyDialog = ({ children }: PrivacyPolicyDialogProps) => {
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>개인정보처리 및 이용</DialogTitle>
        </DialogHeader>
        <ScrollArea className='h-full max-h-[500px] py-4 pr-4'>
          <div className='space-y-6 text-sm leading-normal'>
            <div className='space-y-4'>
              <section>
                <h3 className='font-bold'>1. 개인정보의 처리 목적</h3>
                <div className='mt-2 space-y-2'>
                  <p>
                    {'<'}그리날다{'>'} (&apos;grinalda.co.kr&apos; 이하
                    &apos;그리날다&apos;)는 다음의 목적을 위하여 개인정보를
              ...
              <section>
                <h3 className='font-bold'>2. 개인정보의 처리 및 보유 기간</h3>
                <div className='mt-2 space-y-2'>
                  <ol className='ml-4 list-decimal space-y-1'>
                    <li>
                      {'<'}그리날다{'>'}는 정보주체로부터 개인정보를 수집할 때
              ...
              <section>
                <h3 className='font-bold'>4. 처리하는 개인정보의 항목</h3>
                <div className='mt-2 space-y-2'>
                  <div>
                    <p className='font-medium'>
                      ① {'<'}홈페이지 내 서비스를 제공하기 위하여,{'>'}
                    </p>
                    <ul className='ml-4 mt-1 list-disc space-y-1'>
                      <li>
                        필수항목 : 휴대전화번호, 비밀번호, 로그인ID, 성별, 이름,
                        서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보,
                        결제기록, 사용자구분
                      </li>
                      <li>선택항목 : 이메일, 학력, SMS 수신여부</li>
                    </ul>
                  </div>
                  <div>
                    <p className='font-medium'>
              ...
              <section>
                <h3 className='font-bold'>5. 개인정보의 파기</h3>
                <div className='mt-2 space-y-2'>
                  <p>
                    {'<'}그리날다{'>'}는 원칙적으로 개인정보 처리목적이 달성된
                    경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차,
                    기한 및 방법은 다음과 같습니다.
                  </p>
                  <div className='space-y-2'>
                    <div>
                      ...
                      <p className='ml-4'>
                        ...
                        법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다. 이
                        때, DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는
                        다른 목적으로 이용되지 않습니다.
                      </p>
                    </div>
                    <div>
                      <p className='font-medium'>- 파기기한</p>
                      <p className='ml-4'>
                    ...
                    <li>
                      ...
                      <ol className='ml-4 mt-1 list-[lower-alpha] space-y-1'>
                        <li>
                          ...
                          보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보
                          제공을 위해 사용됩니다.
                        </li>
                        <li>
                          쿠키의 설치·운영 및 거부 : 웹브라우저 상단의 도구{'>'}
                          인터넷 옵션{'>'}
                          개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할
                          수 있습니다.
                        </li>
                        <li>
              ...
              <section>
                <h3 className='font-bold'>7. 개인정보 보호책임자</h3>
                <div className='mt-2 space-y-2'>
                  <p>
                    {'<'}그리날다{'>'}는 개인정보 처리에 관한 업무를 총괄해서
                  ...
                  <div className='ml-4'>
                    ...
                    <ul className='ml-4 list-disc'>
                      <li>성명: 최승남</li>
                      <li>직책: 대표</li>
                      <li>연락처: 025383757 / grinalda@grinalda.co.kr</li>
                    </ul>
                  </div>
                  <p>
                    정보주체께서는 {'<'}그리날다{'>'}의 서비스(또는 사업)을
                    이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
                    피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
                    문의하실 수 있습니다. {'<'}그리날다{'>'}는 정보주체의 문의에
              ...
              <section>
                <h3 className='font-bold'>8. 개인정보 처리방침 변경</h3>
                <div className='mt-2'>
                  <p>
              ...
              <section>
                <h3 className='font-bold'>9. 개인정보의 안전성 확보 조치</h3>
                <div className='mt-2 space-y-2'>
                  <p>
                    {'<'}그리날다{'>'}는 개인정보보호법 제29조에 따라 다음과
                  ...
                  <ol className='ml-4 list-decimal space-y-1'>
                    ...
                    <li>
                      <span className='font-medium'>개인정보의 암호화</span>
                      <p className='mt-1'>
