...
import { SchoolRecordSubjectInput } from '@/apis/hooks/use-school-record';
import { SchoolSubjectGroup } from '@/apis/hooks/use-subjects';

export const SubjectInputItem = memo(
  ({
    index,
    ...
    subject: SchoolRecordSubjectInput;
    ...
    return (
      <div className='flex items-center gap-2'>
        ...
        <Input
          ...
          placeholder='표준편차'
          type='text'
          value={subject.standardDeviation || ''}
          onChange={(e) =>
        ...
        <Input
          ...
          placeholder='석차등급'
          type='text'
          value={subject.gradeRank || ''}
          onChange={(e) =>
            onChangeSubjectValue(index, 'gradeRank', e.target.value)
          }
        />
      </div>
    );
...
SubjectInputItem.displayName = 'SubjectInputItem';
